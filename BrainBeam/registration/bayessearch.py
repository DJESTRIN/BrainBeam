...
def find_affine_matrix(fixed_image,moving_image, drop_dir,ntrials=10000,best_params=None,graph_trial=500):
    ...
    if best_params is None:
        ...
        study.optimize(lambda trial: objective(trial, fixed_image, moving_image), n_trials=ntrials, n_jobs=8,  show_progress_bar=True, callbacks=[lambda s, t: current_param_graph(s, t, moving_image, fixed_image, drop_dir)])  # Run optimization for 100 trials
